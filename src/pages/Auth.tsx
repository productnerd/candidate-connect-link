...
export default function Auth() {
  ...
  return <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-cover bg-center bg-no-repeat" style={{
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 bg-background">
        ...
        {isEmployer && <div className="w-full max-w-md mb-6">
            <div className="flex items-center justify-center p-1 rounded-lg bg-muted">
              <Link to="/auth/employer" className="flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-md text-[10px] font-medium uppercase tracking-wider transition-all bg-background shadow-sm text-foreground">
                <Building2 className="h-3 w-3" />
                Business
              </Link>
              <Link to="/auth/candidate" className="flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-md text-[10px] font-medium uppercase tracking-wider transition-all text-muted-foreground hover:text-foreground">
